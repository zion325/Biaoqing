                    ...
                    >
                        <ScrollView>
                            ...
                            <View style={styles.button}>
                                ...
                                >
                                    <View
                                        style={{ backgroundColor: '#fff', flexDirection: 'row', justifyContent: 'center', borderWidth: 1, borderRadius: 5 }}>
                                        <Text>注册</Text>
                                    </View>
                                </TouchableOpacity>
                            </View>
...
export default connect(null,{ loginTure,tabbarTure,tabbarFalse })(Login);
